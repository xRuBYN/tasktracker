...
import reducer, { createEntity, deleteEntity, getEntities, getEntity, updateEntity, partialUpdateEntity, reset } from './issue.reducer';
...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_ISSUE_LIST actions', async () => {
    ...
    it('dispatches FETCH_ISSUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_ISSUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_ISSUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_ISSUE actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_ISSUE actions', async () => {
      const expectedActions = [
        {
