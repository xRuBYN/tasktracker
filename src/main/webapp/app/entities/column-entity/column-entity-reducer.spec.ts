...
describe('Entities reducer tests', () => {
  ...
  describe('Actions', () => {
    ...
    it('dispatches FETCH_COLUMNENTITY_LIST actions', async () => {
    ...
    it('dispatches FETCH_COLUMNENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches CREATE_COLUMNENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches UPDATE_COLUMNENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches PARTIAL_UPDATE_COLUMNENTITY actions', async () => {
      const expectedActions = [
        {
    ...
    it('dispatches DELETE_COLUMNENTITY actions', async () => {
      const expectedActions = [
        {
